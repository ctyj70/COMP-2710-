/**
* Name - project2_Young_cty0008.cpp
...
void test_aaron_shoots_1(void) {
    ...
    cout << "Unit Testing 2: Function - Aaron_shoots_1(Bob_alive, Charlie_alive)\n";
...
void test_aaron_shoots_2(void) {
    ...
    cout << "Unit Testing 5: Function - aaron_shoots_2(Bob_aive, Charlie_alive)\n";
...
int main() {
    ...
    cout << "*** Welcome to CJ's Duel Simulator ***\n";
    // Unit Testing
